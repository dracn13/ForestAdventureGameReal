...
public class CollisionTesting : MonoBehaviour {
    // This function will run once at the start of each new collision
    void OnCollisionEnter2D(Collision2D collision)
    {
        Debug.Log("I started a new collision");
    }
    // This function will run every frame that we continue to be in a collision
    void OnCollisionStay2D(Collision2D collision)
    {
        Debug.Log("I am staying in collision");
    }
    // This function will run once when we end our collision
